...
Whether the triggered action will deploy the project to production or preview is
determined by the branch name. If the name of the branch that triggers the
action matches the production branch configured in the Deno Deploy dashboard,
